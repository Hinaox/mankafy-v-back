...
router.post('/login', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (isPasswordValid) {
            ...
            const token = jwt.sign({ userId: user.id, email: user.email, username: user.username, profilPic: user.profilPic, firstName: user.firstName, lastName: user.lastName }, // Payload
